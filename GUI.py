...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.bicubicRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.bicubicRadioButton.setObjectName("bicubicRadioButton")
        self.gridLayout_3.addWidget(self.bicubicRadioButton, 0, 0, 1, 1)
        ...
        self.biCubicOneChunkRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.biCubicOneChunkRadioButton.setObjectName("biCubicOneChunkRadioButton")
        self.gridLayout_3.addWidget(self.biCubicOneChunkRadioButton, 1, 0, 1, 1)
        self.biCubicMultipleChunksRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.biCubicMultipleChunksRadioButton.setObjectName("biCubicMultipleChunksRadioButton")
        self.gridLayout_3.addWidget(self.biCubicMultipleChunksRadioButton, 2, 0, 1, 1)
        self.biCubicNumberOfChunksLabel = QtWidgets.QLabel(self.widget1)
        self.biCubicNumberOfChunksLabel.setObjectName("biCubicNumberOfChunksLabel")
        self.gridLayout_3.addWidget(self.biCubicNumberOfChunksLabel, 3, 0, 1, 1)
        self.biCubicNumberOfChunksSpinBox = QtWidgets.QSpinBox(self.widget1)
        self.biCubicNumberOfChunksSpinBox.setMinimum(1)
        self.biCubicNumberOfChunksSpinBox.setMaximum(20)
        self.biCubicNumberOfChunksSpinBox.setObjectName("biCubicNumberOfChunksSpinBox")
        self.gridLayout_3.addWidget(self.biCubicNumberOfChunksSpinBox, 4, 0, 1, 1)
        self.biCubicNoOverlappingRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.biCubicNoOverlappingRadioButton.setObjectName("biCubicNoOverlappingRadioButton")
        self.gridLayout_3.addWidget(self.biCubicNoOverlappingRadioButton, 5, 0, 1, 1)
        self.biCubicOverlappingRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.biCubicOverlappingRadioButton.setObjectName("biCubicOverlappingRadioButton")
        self.gridLayout_3.addWidget(self.biCubicOverlappingRadioButton, 6, 0, 1, 1)
        self.biCubicOverlapLabel = QtWidgets.QLabel(self.widget1)
        self.biCubicOverlapLabel.setObjectName("biCubicOverlapLabel")
        self.gridLayout_3.addWidget(self.biCubicOverlapLabel, 7, 0, 1, 1)
        self.biCubicOverlapSpinBox = QtWidgets.QSpinBox(self.widget1)
        self.biCubicOverlapSpinBox.setMaximum(25)
        self.biCubicOverlapSpinBox.setObjectName("biCubicOverlapSpinBox")
        self.gridLayout_3.addWidget(self.biCubicOverlapSpinBox, 8, 0, 1, 1)
        self.biCubicConstantChunkRadioButton = QtWidgets.QRadioButton(self.widget1)
        font = QtGui.QFont()
        font.setStrikeOut(False)
        self.biCubicConstantChunkRadioButton.setFont(font)
        self.biCubicConstantChunkRadioButton.setAutoRepeat(False)
        self.biCubicConstantChunkRadioButton.setObjectName("biCubicConstantChunkRadioButton")
        self.gridLayout_3.addWidget(self.biCubicConstantChunkRadioButton, 9, 0, 1, 1)
        self.biCubicFullCoverageRadioButton = QtWidgets.QRadioButton(self.widget1)
        self.biCubicFullCoverageRadioButton.setObjectName("biCubicFullCoverageRadioButton")
        self.gridLayout_3.addWidget(self.biCubicFullCoverageRadioButton, 10, 0, 1, 1)
        self.biCubicFitPushButton = QtWidgets.QPushButton(self.widget1)
        self.biCubicFitPushButton.setObjectName("biCubicFitPushButton")
        self.gridLayout_3.addWidget(self.biCubicFitPushButton, 11, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.splineRadioButton.setText(_translate("MainWindow", "Cubic Spline"))
        ...
        self.biCubicOneChunkRadioButton.setText(_translate("MainWindow", "One Chunk"))
        self.biCubicMultipleChunksRadioButton.setText(_translate("MainWindow", "Multiple Chunks"))
        self.biCubicNumberOfChunksLabel.setText(_translate("MainWindow", "Number of Chunks"))
        self.biCubicNoOverlappingRadioButton.setText(_translate("MainWindow", "No Overlapping"))
        self.biCubicOverlappingRadioButton.setText(_translate("MainWindow", "Overlapping"))
        self.biCubicOverlapLabel.setText(_translate("MainWindow", "overlap"))
        self.biCubicConstantChunkRadioButton.setText(_translate("MainWindow", "Keep user input\'s number of chunks constant"))
        self.biCubicFullCoverageRadioButton.setText(_translate("MainWindow", "Keep 100% signal curve fitting coverage"))
        self.biCubicFitPushButton.setText(_translate("MainWindow", "Fit"))
